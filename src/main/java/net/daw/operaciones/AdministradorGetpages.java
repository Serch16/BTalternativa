 ...
 * @author Jacobo
 */
public class AdministradorGetpages implements GenericOperation {
    @Override
    public String execute(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        try {
            ...
            int pages = oAdministradorDAO.getPages(rpp, alFilter, hmOrder);
            data = "{\"data\":\"" + Integer.toString(pages) + "\"}";
            return data;
        } catch (Exception e) {
            throw new ServletException("AdministradorGetpagesJson: View Error: " + e.getMessage());
        }
    }
}
