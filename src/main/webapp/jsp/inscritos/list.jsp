...
<%@page import="es.imeon.dao.InscritosDao"%>
<%@page import="java.util.ArrayList"%>
<%@page import="java.util.Iterator"%>
<%
    InscritosDao oInscritosDao = new InscritosDao(Conexion.getConection());
    ArrayList<String> alColumnsNames = (ArrayList<String>) oInscritosDao.getColumnsNames();
    Iterator<String> oIterador = alColumnsNames.listIterator();
    String strNombreMantenimiento = "inscritos";
%>
